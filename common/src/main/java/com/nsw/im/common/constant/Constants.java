package com.nsw.im.common.constant;
...
public class Constants {
    ...
    /**
     *  客户端(终端)类型：pc端， 移动端， web端
     */
    public static final String ClientType = "clientType";

    /**
     * 设备号：区分相同终端的不同设备(系统),如果pc端: window和mac 移动端: 安卓和ios
     */
    ...
    public static class RabbitConstants {
        ...
        public static final String MessageService2Im = "message Service2Pipeline";
